<template>
  <div class="ui modal dimmable crowds">
...
export default {
  ...
  computed: {
    formLoading: function() {
      return this.$store.state.crowdsForm.formLoading;
    },
    title: {
      get() {
        return this.$store.state.crowdsForm.title;
      },
      set(value) {
  ...
  updated: function() {
    ...
    $(".ui.modal.crowds .ui.form").form({
      ...
      onSuccess: function(event, fields) {
        if (component.$store.state.crowdsForm.crowdsID) {
          ...
          component.$store.dispatch("crowdsForm/putCrowd", function() {
            $(".ui.modal.crowds").modal("hide");
            component.$store.commit("crowdsForm/reset");
            $(".ui.modal.crowds .ui.form").form("clear");
          });
